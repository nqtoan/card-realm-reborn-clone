...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap text-sm font-medium transition-all focus-visible:outline-none disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        default: "button-neo bg-neo-yellow text-neo-black hover:bg-[#E09D05] font-semibold",
        destructive:
          "button-neo bg-destructive text-destructive-foreground hover:bg-destructive/90 font-semibold",
        outline:
          "button-neo border-2 border-white bg-transparent text-neo-beige hover:bg-neo-beige hover:text-neo-black font-semibold",
        secondary:
          "button-neo button-neo-purple bg-neo-purple text-neo-black hover:bg-[#B89BC0] font-semibold",
